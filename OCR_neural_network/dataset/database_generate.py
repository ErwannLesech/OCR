    ...
    for prop in fontsizes:
        ...
        with webfont(fonturl + "?raw=true") as f:
            ...
            for digit in range(0, 10):
                ...
                img.save('OCR_neural_network/dataset/training/' + str(digit) + format(count[digit], "01") + '.jpg')
                count[digit] += 1

                print("Generated image batch " + format(count[digit], "01") + format(variationnum, "01"), end="\r")
